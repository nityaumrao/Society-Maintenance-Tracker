...
const features = [
  {
    ...
    description: "Submit maintenance complaints with detailed descriptions and optional photos."
  },
  {
  ...
  },
  {
    ...
    description: "Upload images to provide better context for maintenance issues."
  },
  {
    title: "Notice Board",
  ...
  },
  {
    ...
    description: "Receive instant updates whenever complaint status changes."
  }
];
